...
class GiftUserRegisterForm(UserCreationForm):
    class Meta:
        model = GiftUser
        fields = ('username', 'first_name', 'last_name', 'password1', 'password2', 'email', 'age', 'avatar', 'gender')
        # fields = '__all__'
...
class GiftUserEditForm(UserChangeForm):
    ...
    class Meta:
        model = GiftUser
        fields = ('first_name', 'middle_name', 'address', 'last_name', 'password', 'email', 'age', 'avatar', 'gender')
