    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active_key_expires', models.DateTimeField(default=datetime.datetime(2019, 6, 21, 20, 19, 20, 923720, tzinfo=utc))),
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='addressapp.Address')),
